                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="cedula" name="id" placeholder="Cedula" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" id="nombre" name="password" placeholder="password" required="">
                                            </div>
                                        </div>
