...
<body style="background-color: white;padding-left: 30px;padding-right: 30px;background-position: center center;background-attachment: fixed;
">
...
<div class="row" style="background-color:  #032a58;padding-bottom: 10px;padding-top: 10px;background-size: cover">
...
<div class="col-3">
    ...
    <div class="col-2" style="padding-left:10px;">
          <form style="padding-left: 10px" method="GET" action="{{route('listarcitas')}}">
          <h3 style="text-align: center;color: white">Citas</h3>
          <input type="date" class="form-control" id="fecha" name="fecha">
        <button class="form-control" style="background-color:white;color: black" type="submit" class="redondo btn btn-info">Filtar</button>
    </form>
    </div>
...
<h6>{{$fechavalor}}</h6>
<h3 style="color:red" align="center"> Checkout </h3>
<table id="tablax" class="table table-striped table-bordered" style="width:100%" >                                              <thead >
                                              ...
                                              <tbody>
                                                @foreach ($citasout as $cpre)
                                                <tr>
                                                  <th> {{$cpre->hora_inicio}}</th>
                                                  <th> {{$cpre->hora_fin}}</th>
                                                  <th> {{$cpre->id}}</th>
                                                  <th> {{$cpre->nombre}}</th>
                                                  <th> {{$cpre->habitacion}}</th>
...
<div class="col-6" style="padding-top: 20px" >
<h6>{{$fechavalor}}</h6>
<h3 style="color:green" align="center">Pre-Checkout</h3>
