...
<body style="background-color: #032a58">
   ...
   <div class="row justify-content-md-center">
                    <div class="col-md-4 register-right" style="background-color: transparent;"> 
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          <div class="row register-form">
                            <div class="col-md-12 register-right" style="padding-top: 10px;padding-bottom: 10px;background-color: transparent;">
                             <div class="form-group" style="background-color: #032a58;">

                      <h4 style="color: white; font-family:Lato" >
                        Sr. {{$nombre}} <br>su cita  {{$tipocita}} <br> Para el dia: {{$fecha}}<br> De {{$agenda->hora_inicio}} A {{$agenda->hora_fin}}<br> En la torre: {{$torre}}<br> Ha sido grabada con exito <br>
                      </h4>
                       @if($tipocita === 'precheckout')
                      <form method="POST" action="{{route('crearcliente')}}">
                          ...
                          <input type="hidden" value="{{$habitacion}}" name="habitacion">
                          <input type="hidden" name="fecha" value="{{$fecha}}">
                          <input type="hidden" name="precheckout" value="1">
                          <button type="submit" style="background-color: #1E43BF; color: white;font-family: Lato"> ¿ Reservar check out ?</button>
                           
                      </form>
                      @endif
                      <br><br>
                       <h3 style="color: white; font-family: Lato">Gracias por su tiempo</h3>
                      </div> 
                    </div>
                    </div>
                    </div>
