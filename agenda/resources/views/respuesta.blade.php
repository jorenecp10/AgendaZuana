...
<body style="background-color: white;padding-left: 30px;padding-right: 30px">
 ...
 <div class="row" >
  ...
  <a class="dropdown-item" href="{{ route('logout') }}"
    ...
    @if(!empty($arraynocreadas))
     <div class="col-12" style="background-color: red;padding-left:0px;padding-right: 0px">
        <h6>No se crearon algunas agendas porque los horarios se cruzan con una existente</h6>
    </div>
    @else
    <div class="col-12" style="background-color: green">
        <h6>Agendas Creadas Correctamente</h6>
    </div>
    @endif
...
<h3 style="color:green" align="center"> Creadas </h3>
...
<div class="col-6" style="padding-top: 20px" >
<h3 style="color:red" align="center">No Creadas</h3>
<table id="tablax1" class="table table-striped table-bordered" style="width:100%" >
                                              ...
                                              <tbody>
                                                @foreach ($arraynocreadas as $torre)
